...
describe("loadUserThemePacks", () => {
  ...
  it("loads a pack dropped into its own sub-directory, named after its scheme", () => {
    writePack("my-dracula", { family: "My Dracula", scheme: MY_DRACULA_SCHEME });
  ...
  it("reports a malformed manifest by the pack's directory name and skips only that pack", () => {
    ...
    writePack("fine", { scheme: DRACULA_SCHEME });
