...
export function isNerdFontFamilyName(fontFamilyName) {
...
function stripFontTypeSuffix(valueName) {
...
export function parseFontFamilyNamesFromRegQueryOutput(regQueryStdout) {
    return regQueryStdout
        .split(/\r?\n/)
        .map((line) => REG_FONT_VALUE_LINE_REGEX.exec(line)?.[1])
        .filter((valueName) => valueName !== undefined)
 ...
 */
export function listInstalledFontFamilyNames() {
 ...
 */
export function evaluateNerdFontStatus(installedFontFamilyNames, selectedFontFace) {
...
export const NERD_FONT_INSTALL_ARGS = ["font", "install", "meslo", "--headless"];
/**
 ...
 */
export function installNerdFont() {
...
//# sourceMappingURL=nerd-font.js.map