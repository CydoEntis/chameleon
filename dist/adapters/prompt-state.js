...
export function defaultPromptStatePath() {
 ...
 */
export function readPromptState(statePath = defaultPromptStatePath()) {
...
export function writePromptState(state, statePath = defaultPromptStatePath()) {
