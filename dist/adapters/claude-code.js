...
const STATUSLINE_CONFIG_VALUE = { type: "command", command: STATUSLINE_COMMAND };
/**
 ...
 */
const CLAUDE_CODE_ANSI_THEME_FOR = {
    dark: "dark-ansi",
    light: "light-ansi",
};
const CLAUDE_CODE_DALTONIZED_THEME_FOR = {
    dark: "dark-daltonized",
    light: "light-daltonized",
};
const CLAUDE_CODE_DALTONIZED_THEMES = new Set(Object.values(CLAUDE_CODE_DALTONIZED_THEME_FOR));
/**
 ...
 */
function themeToWriteFor(existingTheme, appearance) {
 ...
 */
export function claudeCodeMatchesAppearance(settings, appearance) {
 ...
 */
const KEPT_EXISTING_STATUS_LINE_NOTICE = "kept your existing statusLine instead of installing Chameleon's own — run `chm statusline on` to switch to it";
/**
 ...
 */
function ensureStatusLineConfigured(settingsPath, text, existingStatusLine, statuslineStatePath) {
 ...
 */
function applyClaudeCodeTheme(settingsPath, appearance, statuslineStatePath) {
 ...
 */
export function createClaudeCodeAdapter(settingsPath = defaultSettingsPath(), statuslineStatePath = defaultStatuslineStatePath()) {
    return {
 ...
 */
export function isClaudeCodeStatusLineEnabled(statuslineStatePath = defaultStatuslineStatePath()) {
 ...
 */
export function describeStatusLine(statusLine) {
    if (statusLine === undefined)
        return "none configured";
    const parsed = StatusLineCommandShapeSchema.safeParse(statusLine);
    if (!parsed.success)
        return "a custom statusLine";
 ...
 */
export function enableClaudeCodeStatusLine(settingsPath = defaultSettingsPath(), statuslineStatePath = defaultStatuslineStatePath()) {
 ...
 */
export function disableClaudeCodeStatusLine(statuslineStatePath = defaultStatuslineStatePath()) {
 ...
 */
export function undoClaudeCode(settingsPath = defaultSettingsPath()) {
