...
const OH_MY_POSH_FONT_SUBCOMMAND = ["font", "install"];
 ...
 */
function installedFontFamilyNames() {
    ...
    return result.stdout
        ...
        .filter((fontFamilyName) => fontFamilyName !== undefined)
 ...
 * the ticket."
 */
export function detectNerdFontInstalled() {
...
export function nerdFontInstallCommand(fontName = DEFAULT_NERD_FONT_NAME) {
