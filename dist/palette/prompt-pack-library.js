...
import { z } from "zod";
import { assertPromptLayoutIsSafe, parsePromptLayout, PromptPackManifestSchema } from "./prompt-pack.js";
...
function layoutFileNameFor(manifest) {
 ...
 * user-owned.
 */
export function loadBundledPromptPacks() {
    const indexRaw = JSON.parse(readFileSync(path.join(PROMPT_PACK_DIR, "index.json"), "utf8"));
...
//# sourceMappingURL=prompt-pack-library.js.map