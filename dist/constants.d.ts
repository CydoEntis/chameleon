 ...
 */
export declare const APPEARANCE_LUMINANCE_THRESHOLD = 0.5;
/**
 ...
 */
export declare const WCAG_CONTRAST_OFFSET = 0.05;
/**
 ...
 */
export declare const ROLES: readonly ["ground", "body", "accent", "muted", "success", "error"];
...
export declare function isKnownRole(candidateRole: string): candidateRole is Role;
/**
 ...
 */
export declare const TEXT_MIN_RATIO = 4.5;
/**
 ...
 */
export declare const MUTED_MIN_RATIO = 3;
/**
 ...
 */
export declare const SELECTION_IDEAL_RATIO = 2;
/**
 ...
 */
export declare const SELECTION_MIN_VISIBLE_RATIO = 1.25;
/**
 ...
 */
export declare const RATIO_CLEARANCE_MARGIN = 1.05;
/**
 ...
 * near this ceiling.
 */
export declare const SELECTION_MIN_CHROMA = 0.05;
export declare const SELECTION_MAX_CHROMA = 0.08;
/**
 ...
 */
export declare const SELECTION_MIN_RESOLVED_CHROMA = 0.15;
/**
 ...
 */
export declare const SELECTION_HUE_MIN_DISTANCE_DEGREES = 20;
/**
 ...
 */
export declare const ACTIVE_ROW_MIN_VISIBLE_RATIO = 1.25;
/**
 ...
 */
export declare const PANEL_MIN_VISIBLE_RATIO = 1.25;
/**
 ...
 */
export declare const MIN_REPAIRED_CHROMA = 0.2;
/**
 ...
 */
export declare const ANSI_MIN_RATIO = 2;
/**
 ...
 */
export declare const RED_HUE_MAX_DEGREES = 20;
export declare const RED_HUE_WRAP_MIN_DEGREES = 345;
export declare const GREEN_HUE_MIN_DEGREES = 60;
export declare const GREEN_HUE_MAX_DEGREES = 170;
