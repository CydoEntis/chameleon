 ...
 * with its origin — see CLAUDE.md, "ch list shows bundled and user packs
 * together, marking which is which." A malformed user pack is reported by
 * name on stderr and does not stop the rest of the list from printing.
 */
